...
myApp.onPageInit('news', function (page) {
	//$$.getJSON('https://webhozz-training.com/iwalk/apps/news.php',{par:'val'}, function(data){
	$$.getJSON('http://localhost:8080/androidMaster2/apps/get_news.php', {
		par: 'val'
	}, function (data) {
...
myApp.onPageInit('news_detail', function (page) {
	//$$.getJSON('https://webhozz-training.com/iwalk/apps/news.php',{id:page.query.id},function	(data){
	$$.getJSON('http://localhost:8080/androidMaster2/apps/get_detail.php', {
		id: page.query.id
	}, function (data) {
		$$.each(data, function (index, element) {
